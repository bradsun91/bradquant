...
##### Calculate prepping for net strategy's Alpha, not Jensen's constant #####
        ...
        ax7.set_title('Underwater/Drawdown Graph', fontsize = 16)
        ax7.set_xlabel('none').set_visible(False)

        # plot watermark
        water_mark_sr.plot(ax = ax8, color = 'green', lw = 1)
        ax8.set_title('Watermark Curve', fontsize = 16)
