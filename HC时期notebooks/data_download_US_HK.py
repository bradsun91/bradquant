...
#---------------------------------0305---------------------------------
	...
	def us_industrial_stocks():
		tickers = list(set(['HON','UPS','UNP','BA','RTX','CAT','MMM','LMT','GE','X','FORD']))
		return tickers	
...
def all_US_tickers():
	...
	print("All US Tickers: {}".format(len(tickers)))
	return tickers
...
def all_HK_tickers():
	...
	print("All HK Tickers: {}".format(len(tickers)))
	return tickers
...
class LOAD_DATA():
	...
	def read_data_from_yf_60m(tickers_list):
		load_count = 1
		data_list = []
		len_tickers = len(tickers_list)
		for ticker in tickers_list:
