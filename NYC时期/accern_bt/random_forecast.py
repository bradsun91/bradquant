...
class MarketOnOpenPortfolio(Portfolio):
    ...
    def backtest_portfolio(self):
        ...
        # each column
        portfolio['holdings'] = self.positions.mul(self.bars['Adj Close'], axis = 'index')
        portfolio['cash'] = self.initial_capital - portfolio['holdings'].cumsum()

        # Finalise the total and bar-based returns based on the 'cash'
        # and 'holdings' figures for the portfolio
        portfolio['total'] = portfolio['cash'] + self.positions[self.symbol].cumsum() * self.bars['Adj Close']
